...
| 007 | 2026-08-09 | Phase 6 — benchmark harness and measured defaults | in-progress | Build the benchmark harness, run the matrix on real hardware, and set evidence-based defaults plus the adaptive-concurrency verdict. |
